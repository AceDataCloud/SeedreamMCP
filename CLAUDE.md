...
MCP (Model Context Protocol) server for Seedream AI image generation via AceDataCloud API.
...
core/
  ...
  types.py      — Literal types (SeedreamModel, etc.)
...
1. **Source of truth** — `_docs/openapi/seedream.json` is the OpenAPI spec for the SeedreamMCP API.
